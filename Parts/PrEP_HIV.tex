...
In France, like in most high-income settings, the number of new HIV infections remains remarkably high in some subpopulations. Between 6\,000 and 7\,000 new HIV infections are estimated to occur each year at the national level \cite[]{Marty2018}. More than 40\% of the new HIV infections occur among people living in Île-de-France (\^IdF)---the Paris region, while only 19\% of the French population lives in this region \cite[]{Marty2018}. The number of new HIV infections has remained rather stable since 2011 \cite[]{Siguier2018,SPF_Rapport2019}.  
...
As of 2019, a 88\%--92\%--82\% progress was achieved among men of 15 years and older in the region of Western and Central Europe and North America \cite[]{UNAIDS_Data2020}.
...
Modeling studies have evaluated the impact of a PrEP rollout on the HIV epidemic among MSM, predicting a remarkable reduction in the number of new HIV infections \cite[]{Gomez2012,Kim2014,Punyacharoensin2016,Jenness2016,Robineau2017,Rozhnova2018,Palk2018,Rozhnova2019,Singleton2020}. Moreover, mathematical models have been recently used to study PrEP interventions among MSM in the context of WHO 95--95--95 initiative and its 90\% incidence reduction target \cite[]{Scott2018,Singleton2020} as well as HIV epidemic elimination through PrEP rollouts among MSM \cite[]{Rozhnova2018,Scott2018,Hansson2020}. In these models, different levels of PrEP coverage are considered \cite[]{Gomez2012,Punyacharoensin2016,Robineau2017,Rozhnova2018,Singleton2020}, including full coverage \cite[]{Kim2014}. However, high levels of PrEP coverage, which are required to substantially impact or eliminate HIV epidemics, may not be granted in the real world. Therefore, it remains to know whether and how PrEP coverage levels can be reached and maintained, in the long term. To the best of our knowledge, no modeling study has addressed the individual-level decision-making on whether or not to adopt a prevention method---namely, PrEP---to avoid HIV infection and thus evaluated the impact of voluntary adoption of PrEP on the HIV epidemic. 
...
\label{PrEP:Article}
A scientific article presenting our findings, titled ``Can HIV epidemics among men who have sex with men be eliminated through participation to PrEP rollouts?'' \cite[]{Jijon2021}, was submitted for publication to \emph{AIDS} in January 2021, and is currently under review. 
...
Risk compensation among non-PrEP users \cite[]{Phanuphak2018} and explicitly modeling condom use among individuals at low risk of infection are left for future research. In addition, considering an age-structured model might help better targeting of high-risk subpopulations, such as young MSM \cite[]{Siguier2018,WHO_KeyPop2016}. 
