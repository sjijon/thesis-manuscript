...
A large-scale survey on confidence in immunization conducted in 2015 found that, while the state of vaccine confidence is overall high worldwide, there are regions where vaccine hesitancy remains a public health challenge \cite[]{Larson2016}; cf.~\figref{fig:Vacc_FigLarson2016}. %Mistrust in immunization concerned both low- and high-income countries. 
Seven of the ten least confident countries were identified in the European region. France was identified as the country having the lowest confidence in vaccine safety, between the 67 countries included in the survey. Only $45.2\%$ of French respondents reported mistrust in vaccine safety (of note, the global average was $13\%$) \cite[]{Larson2016}.
